...
SPARKLE_FEED_URL="https://raw.githubusercontent.com/Foiler25/DotZap/main/appcast.xml"
SPARKLE_PUBLIC_EDKEY="fCKMmaQAtCB3z3MOp6uwYs6Jcp9h9ancLBYBYCP3ByQ="
...
SIGN_UPDATE="$(ls -1 "$HOME"/Library/Developer/Xcode/DerivedData/DotZap-*/SourcePackages/artifacts/sparkle/Sparkle/bin/sign_update 2>/dev/null | head -1)"
